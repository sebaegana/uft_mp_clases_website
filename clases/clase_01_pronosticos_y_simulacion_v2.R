# Prerrequisitos
# - Paquetes: readxl, tidyverse, scales, readr, kableExtra, knitr.
# - Datasets requeridos:
#   * clases/data/precios_latam_ltm_sn.xlsx (o data/... segun directorio de trabajo)
#   * clases/data/df_filtered_respiratorio.xlsx (o data/... segun directorio de trabajo)
...
get_prices_checked <- function(from, to = Sys.Date()) {
  price_candidates <- c(
    file.path("clases", "data", "precios_latam_ltm_sn.xlsx"),
    file.path("data", "precios_latam_ltm_sn.xlsx")
  )
...
# Caso 3: analisis de atenciones respiratorias
...
library(knitr)
resp_candidates <- c(
  file.path("clases", "data", "df_filtered_respiratorio.xlsx"),
  file.path("data", "df_filtered_respiratorio.xlsx")
)
...
# Reporte exploratorio opcional
## Crear reporte
################################################################################

generate_data_report <- FALSE
if (isTRUE(generate_data_report)) {
  message("Reporte exploratorio deshabilitado en v2 para mantener dependencias mas livianas.")
}
